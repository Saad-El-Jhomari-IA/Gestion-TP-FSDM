...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <title>espace_etudiant_principale</title>
</head>
<body>
      ...
      <li class="nav-item dropdown">
        ...
        if($rep==true){
            while($ligne1=$rep->fetch() ){ 
                ...
                <a class="dropdown-item" href="mes_modules-1.php?codemodule=projet_tutore"> Projet tutoré</a><br>
                <?php } if($ligne1["projet_tutore2"]==1){ ?>
                <a class="dropdown-item" href="mes_modules-1.php?codemodule=projet_tutore2">Projet tutoré2</a><br>
...
<div class="container" style="heighT: auto;margin-top:-20px;">
  ...
  <div  style="padding-top:50px;" ><h1 align="center" class=""  style="font-size:50px;"> Espace Etudiant</h1></div>
   ...
   <div class="row" style="padding-top:50px;">
    ...
    <img src="assets/img/fum7.jpg" class="card-img-top" alt="fum1"style="height:150PX;">
            ...
            <div class="card-body"style="padding-top:10px" >
                  ...
                  <div style="padding-top:10px;padding-right:20px; " class="text text-primary" ><a href="mes_modules-1.php?codemodule=<?=$tab[$i]?>"> <p class=" text  text-center " style="font-size:30px;color:blue; "   ><?=$tableau[$tab[$i]] ?> </p></a> </div>
...
?>
  ...
  <a  style="margin-right:30px;" class="btn btn-primary"  href="DECONNEXION_etudiant.php">Déconnexion</a>
