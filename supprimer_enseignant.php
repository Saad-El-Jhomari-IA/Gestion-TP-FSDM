...
<h1 align="center" >Supprimer Un Enseignant</h1>
<div align="center" class="card" style="width: 50%;margin-left:300px;margin-top:40px">
    <h2>Entrer le code d'enseignant que vous voulez supprimer</h2>
<form method = "post">
...
<b>Entrez le nom et Prénom:  </b>   <input  type = "text"  name = "Nom"  required/>
...
$req="DELETE FROM `enseignant` WHERE  cneens='".$_POST["Code"]."' AND nomen= '".$_POST["Nom"]."';";
$rep=$cn1->exec($req);
if($rep){
    header('Location: page_principale_administration.php');
    // echo"suppresion complete";
