...
<body >
  <div style="padding-top:50px;"><h1 align="center">Espace D'authentification Etudiant</h1></div>
  ...
  <form style="  padding-left:70px;border: 2px solid rgb(143, 190, 190);border-radius:30px;" method="POST" action="VERIFICATION_ETUDIANT.php" >
  <div>

  <label for="cne" class="form-label" style="padding-top:10px;">Login</label>
<input type="text" id="cne" class="form-control" aria-labelledby="cnehelp"  name="cne"  placeholder="VOTRE CNE"style="width:200px;" required>
...
<input type="password" id="inputPassword5" class="form-control" aria-labelledby="passwordHelpBlock"  name="password" style="width:200px;" placeholder="mot de passe" required>
<div id="passwordHelpBlock" class="form-text">
 ...
 <ul> <p class="text text-success" style="font-size:18px;">Si vous avez un compte </p>
 <li>Utilisez votre Code Massar ou CNE</li>
 </ul>
 <div><ul> <p class="text text-danger" style="font-size:18px;">Si non </p>
 <li> vous pouvez creé un compte </li>
 </ul>
 <div style="display: flex; justify-content: center;padding-bottom:20px;" >
 <a href="inscription_etudiant.php" class="btn btn-success text-center">Creer</a></div>
 </div>
 </div>
 </div>
 </div>
 ...
 <div style="display: flex; justify-content: center;padding-top:40px; ">
    <a href="acceuil.php" class="btn btn-primary text-center" align="center">Sortir</a>
</div>
